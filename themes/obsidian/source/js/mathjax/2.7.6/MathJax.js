...
if (document.getElementById && document.childNodes && document.createElement) {
    if (!(window.MathJax && MathJax.Hub)) {
            ...
            MenuZoom: function () {
                if (MathJax.Hub.config.showMathMenu) {
                    if (!MathJax.Extension.MathMenu) {
                        setTimeout(function () {
                            MathJax.Callback.Queue(["Require", MathJax.Ajax, "[MathJax]/js/mathjax/2.7.6/extensions/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"])
                        }, 1000)
                    } else {
                        setTimeout(MathJax.Callback(["loadDomain", MathJax.Localization, "MathMenu"]), 1000)
                    }
                    if (!MathJax.Extension.MathZoom) {
                        setTimeout(MathJax.Callback(["Require", MathJax.Ajax, "[MathJax]/js/mathjax/2.7.6/extensions/MathZoom.js", {}]), 2000)
                    }
                }
            },
            onLoad: function () {
        ...
        (function (d) {
            ...
            }, {id: "Jax", version: "2.7.6", directory: e + "/jax", extensionDir: e + "/extensions"});
            ...
            }, {id: "InputJax", version: "2.7.6", directory: g.directory + "/input", extensionDir: g.extensionDir});
            ...
            b.OutputJax.Error = {
                id: "Error", version: "2.7.6", config: {}, errors: 0, ContextMenu: function () {
